<h2>Sale Some Products <button class="btn btn-info btn-sm pull-right" data-toggle="modal" data-target=".add-product-modal">Add Products</button></h2>
      <hr>
...
<table id="table_products" class="table table-striped table-hover table-condensed table-bordered">
	...
	<tbody>
	<?php if (count($daelers->getDaelerProducts($_SESSION['users'])) == 0) { ?>
		<tr>
			<td colspan="8" align="center" class="bg-danger"><span class="label label-danger">Data Not Found!</span></td>
		</tr>
	<?php 
	} else { 
		foreach ($daelers->getDaelerProducts($_SESSION['users']) as $data) {
	?>
		<tr>
...
<div class="modal fade add-product-modal" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel">
      <div class="modal-dialog modal-lg">
              ...
              <div class="row">
                  <div class="col-md-6">
                      <div class="form-group">
                          ...
                          <input type="text" id="product_id" name="product_id" readonly value="<?= $generator->daelerProductID(); ?>" class="form-control">
                      </div>
                      <div class="form-group">
            ...
            <div class="modal-footer">
              ...
              <input type="submit" name="daelerAddItem" class="btn btn-primary" value="Add Product">
              </form>
            </div>
            </div>
      </div>
